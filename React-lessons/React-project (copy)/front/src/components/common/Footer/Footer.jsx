            ...
            <div className="container">
                <div className="footer__column">
                    <strong className="logo footer__logo">
                        <a href="#">
                            <svg width="150" height="35" viewBox="0 0 150 35" fill="none"
                ...
                <div className="footer__column">
                    ...
                    <ul className="footer__list">
                        <li className="footer__list-item"><a href="#" className="link">About Us</a></li>
                        <li className="footer__list-item"><a href="#" className="link">Blog</a></li>
                        <li className="footer__list-item"><a href="#" className="link">Contact</a></li>
                        <li className="footer__list-item"><a href="#" className="link">FAQ</a></li>
                    </ul>
                </div>
                <div className="footer__column">
                    <h4 className="footer__column-title">Legal Stuff</h4>
                    <ul className="footer__list">
                        <li className="footer__list-item"><a href="#" className="link">Disclaimer</a></li>
                        <li className="footer__list-item"><a href="#" className="link">Financing</a></li>
                        <li className="footer__list-item"><a href="#" className="link">Privacy Policy</a></li>
                        <li className="footer__list-item"><a href="#" className="link">Terms of Service</a></li>
                    </ul>
                </div>
                <div className="footer__column">
                    <h4 className="footer__column-title">Would you like to join newsletters?</h4>
                    <form action="#" className="footer__form-sing-up">
                        <div className="field">
