...
function f3() {
   let inp1 = +document.querySelector('.i-31').value;
   let inp2 = +document.querySelector('.i-32').value;
...
function f7() {
   let inp1 = +document.querySelector('.i-71').value;
   let inp2 = +document.querySelector('.i-72').value;
...
function f13() {
   let inp = document.querySelector('.i-130');
   let v = inp.value;
...
function f14() {
   ...
   let inp1 = +document.querySelector('.i-141').value;
   let inp2 = +document.querySelector('.i-142').value;
