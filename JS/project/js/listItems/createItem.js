function createProductItem(item) {
    ...
    btnAddCart.addEventListener('click', (e) => addToSomeList(e, item, itemsCart, dropCart, countMiniCart, 'cart'))

    btnAddFavourite.addEventListener('click', (e) => addToSomeList(e, item, itemsFavourite, dropFavourite, countFavourite, 'favourite'))
...
function addToSomeList(e, item, listCart, out, count, typeList) {
    e.preventDefault()
    if (typeList === 'cart') {
        if (!checkIncludesInCart(listCart, item)) listCart.push(item)
        showProductsInSomeList(listCart, out, count, typeList)
